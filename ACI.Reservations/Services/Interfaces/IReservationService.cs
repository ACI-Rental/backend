...
namespace ACI.Reservations.Services.Interfaces
{
    public interface IReservationService
    {
        ...
        public Task<Either<IError, ReservationDTO>> ReserveProduct(ReservationCreateDTO reservationDTO, AppUser user);
        public Task<Either<IError, ReservationDTO>> EditReservation(ReservationEditDTO reservationEditDTO, AppUser user);
    }
}
