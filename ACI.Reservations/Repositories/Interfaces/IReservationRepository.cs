...
namespace ACI.Reservations.Repositories.Interfaces
{
    public interface IReservationRepository
    {
        ...
        public Task<Either<IError, Reservation>> GetOverlappingReservation(Guid reservationId, Guid productId, DateTime startDate, DateTime endDate);
        ...
        public Task<Either<IError, Reservation>> EditReservation(Reservation reservation);
    }
}
